...
(function () {
  ...
  formatChatMessage = function (e, t) {
    ...
    if (2 == res.children().size() && res[ 0 ].className.startsWith("chat-msg-") &&
        "intro" !== res.attr("data-type")) {
      ...
      var parse_wolfram_embed = function (msg) {
        return msg.split(escape + "; " + escape)
          ...
          .map(function (line) {
            return {
              "key": line[ 0 ].trim(),
              "value": line[ 1 ] ? line[ 1 ].split(escape + ", " + escape).map(function (str) {
                return str.trim();
              }) : []
            };
          });
    ...
    Schedule.prototype.load = function (e) {
      ...
      var render_event = function (data) {
        ...
        if (window.CUSTOM.mobile) {
          ...
          return '<tr><td class="vertical-middle"><a href="' + event.link + '">' + escape_html(event.title) +
                 '</a></td><td class="vertical-middle">' + escape_html(event.region || "") +
  ...
  var init_settings = function () {
    ...
    Settings.prototype.load = function () {
      var render_toggle = function (name, data) {
        ...
        if (data.handler) toggle.change(data.handler); else
